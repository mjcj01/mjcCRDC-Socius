...
### check wh bl rr ### done!
### add oss and cp for y axis on rr and rd ### done!
### add note abt earlier OSS data ### remove filter ### done!
### add graph for sample of states where it is always illegal ### done!
### keep same filter ### done
### fix OSS graphs to include 2021 ### done!
### remove legend titles for all ### done!
### add (OSS) after title ### done!
### note states that are in always legal sample ### done!
